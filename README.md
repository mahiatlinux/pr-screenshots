...
Run the scripts with `PYTHONPATH=studio/backend` and the dependencies in `final-requirements.txt`, inside an isolated credential-free environment. Compare the merge base `16408b25fdef12133be49e117cdd5f9a3382cb3a`, original head `6e2f3da93999d1726ef6136d68896b658eb6fa73`, and repaired source `f35270122`.
...
`merge-tests.log` runs `test_sandbox_tools.py` on the reviewed prospective merge tree `17faac58c`.
