...
code="import operator,paramiko; c=paramiko.SSHClient(); c.set_missing_host_key_policy(paramiko.AutoAddPolicy()); operator.methodcaller('connect',hostname='127.0.0.2',port=22222,username='review',password='review',allow_agent=False,look_for_keys=False)(c); print(c.exec_command('uptime')[1].read().decode()); c.close()"
